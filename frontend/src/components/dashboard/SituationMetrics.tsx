      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
        ...
        <Card>
          <CardContent className="p-4">
            ...
            <div className="text-2xl font-bold text-text-primary">{metrics.active_alerts_count}</div>
            <span className="text-[11px] text-text-secondary mt-1 block">Live advisories</span>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="p-4">
            ...
            <span className="text-[11px] text-text-secondary mt-1 block">High risk level</span>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="p-4">
            ...
            <div className="text-2xl font-bold text-text-primary">{metrics.affected_districts_count}</div>
            <span className="text-[11px] text-text-secondary mt-1 block">Under advisory</span>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="p-4">
            ...
            <span className="text-[11px] text-text-secondary mt-1 block">Scrapers operational</span>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="p-4">
            ...
            <div className="text-2xl font-bold text-text-primary">{metrics.unhealthy_sources_count}</div>
            <span className="text-[11px] text-text-secondary mt-1 block">Requiring review</span>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="p-4">
            ...
            <div className="text-lg font-bold text-text-primary">60s</div>
            <span className="text-[11px] text-text-secondary mt-1 block">Auto-refreshed</span>
          </CardContent>
        </Card>
