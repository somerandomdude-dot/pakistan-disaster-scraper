...
export default function AdvisorySummary({
  ...
  return (
    <section aria-labelledby="advisory-summary-heading">
      ...
      <dl className="grid grid-cols-1 border border-slate-200 dark:border-slate-700 bg-background sm:grid-cols-2 lg:grid-cols-3">
        {facts.map((fact) => (
          <div key={fact.label} className="border-b border-slate-200 dark:border-slate-700 px-3 py-2.5 sm:border-r">
